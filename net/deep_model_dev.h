...
//#include "abacus/deep_learning/deep_model_result.h"
//#include "abacus/deep_learning/feature.h"
//#include "abacus/deep_learning/flag.h"
...
public:
    IOBuffer(size_t size, nvinfer1::DataType type, bool is_host)
        ...
        if (!success) {
            LOG(FATAL) << "Cannot alloc the memory!";
        }
    }
